...
class LoadAnnotations:
    ...
    def _load_bboxes(self, results):
        ...
        results['gt_bboxes'] = ann_info['bbox'].copy()
        # change by hui
        for keys, new_key in [(["bbox_ignore"], "gt_bboxes_ignore"),
                              (["true_bboxes", "bbox"], "gt_true_bboxes")]:
            for key in keys:
    ...
    def _load_labels(self, results):
        ...
        # 添加对bfov和points字段的支持这里是我自己改的bfov和points
        if 'bfov' in results['ann_info']:
            results['gt_bfov'] = results['ann_info']['bfov'].copy()
        if 'point' in results['ann_info']:
            results['gt_points'] = results['ann_info']['point'].copy()
